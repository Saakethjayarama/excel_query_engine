import json, re, utils, os
from glob import glob
from ExcelQueryEngine_xlwings import ExcelQueryEngine
...
def get_parsed_data(filename="ecap.xlsx"):
    eqe = ExcelQueryEngine(filename)
    (INSPECTION_RESULT_SHEET, EVALUATION_RESULT_SHEET) = getSheetNames(eqe.data.keys())
    ...
    content = eqe.get_columns_from_row_to_row(
        INSPECTION_RESULT_SHEET,
